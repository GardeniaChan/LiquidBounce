...
public class BlackStyle extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.getFontHeight() + 3, 3F, new Color(40,40,40).getRGB(), new Color(40,40,40).getRGB());
        GlStateManager.resetColor();
            ...
            if(moduleElement.isShowSettings()) {
                ...
                for(final Value value : moduleValues) {
                    ...
                    if(value instanceof BoolValue) {
                        ...
                        if(mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.slowlySettingsYPos && mouseY <= moduleElement.slowlySettingsYPos + Fonts.font35.getStringWidth(text) && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                        ...
                        for(final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.openList) {
                                ...
                                moduleElement.slowlySettingsYPos += Fonts.font35.getStringWidth(text) + 1;
                            }
                        }
