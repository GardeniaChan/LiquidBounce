...
public class Animation extends Module {
    ...
    private static final String[] renderMode = new String[] {
            "IDBUG",
            "Swang",
            "Swank",
            "Swing",
    ...
    public static final FloatValue itemPosX = new FloatValue("ItemPosX", (float) 0.26, -1, 1);
    public static final FloatValue itemPosY = new FloatValue("ItemPosY", (float)0.02, -1, 1);
    public static final FloatValue itemPosZ = new FloatValue("ItemPosZ", (float)-0.58, -1, 1);
