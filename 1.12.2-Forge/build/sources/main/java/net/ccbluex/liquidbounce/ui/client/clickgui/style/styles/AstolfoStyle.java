...
public class AstolfoStyle extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.SFUI35.getFontHeight() + 3, new Color(26, 26, 26).getRGB());
        GlStateManager.resetColor();
        Fonts.SFUI35.drawString(text.toLowerCase(), mouseX + 12, mouseY + (Fonts.SFUI35.getFontHeight() / 2), Integer.MAX_VALUE);
    }
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    if (value instanceof BoolValue) {
                        ...
                        Fonts.SFUI35.drawString(displayString.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, Color.WHITE.getRGB());
                        int stringWidth = Fonts.SFUI35.getStringWidth(displayString);
